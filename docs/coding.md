...
что позволяется вводить кода используя лишь **числовую клавиатуру** оборудования:
...
перед или после основной кодовой конструкции:
```
1   30(ширина_2_м)
2   30..(ширина_1_м)
3   30..
4   30...1
```
Кодовому обозначению может принадлежать и определенный тип линейного объекта, и точечный объект.

Для **линейного объекта** за кодом закрепляются:

- Слой (тип линии, цвет линии, вес линии)
- Тип линии не по слою
- Вес линии не по слою
